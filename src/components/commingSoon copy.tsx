    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1">
                {/* Hero Section */}
                <section className="relative h-[670px] flex items-center overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-4xl px-4 sm:px-6 lg:px-16 text-white text-left">
                        <div className="mb-8">
                            <div className="relative inline-block px-4 py-2 mb-6 animate-border">
                                <span className="relative z-10 bg-[rgba(255, 255, 255, 1)] text-white px-4 py-2 rounded-full border border-transparent font-Castoro">
                                    COMING SOON
                                </span>
                                <div className="absolute inset-0 rounded-full border-4 border-gradient animate-gradient"></div>
                            </div>
                            ...
                            <p className="text-xl sm:text-1xl font-Playfair text-white mb-8 ">
                        ...
                        <form onSubmit={handleHeroSubmit} className="max-w-md">
                            <div className="flex flex-col sm:flex-row gap-3">
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 rounded-[15px] bg-gray-800 bg-opacity-80 text-white placeholder-gray-300 border border-gray-600 focus:outline-none focus:border-teal-500 focus:ring-2 focus:ring-teal-500"
                                    required
                                />
                                <button
                                    type="submit"
                                    className="bg-[rgba(9,58,48,1)]  hover:bg-teal-500 px-6 py-3 rounded-[15px] font-medium transition-colors duration-200 whitespace-nowrap"
                                >
                                    NOTIFY ME
                                </button>
                            </div>
                    ...
                    <style>{`@keyframes gradientMove {
                        ...
                        .border-gradient {
                        border-image: linear-gradient(270deg, #013220, #025d34, #037d50, #013220);
                        border-image-slice: 1;
                        }

                        .animate-gradient {
                        background: linear-gradient(270deg, #013220, #025d34, #037d50, #013220);
                ...
                {/* Features Section */}
                <section className="bg-purple-50 px-4 pt-[150px]  sm:px-6 lg:px-8">
                ...
                {/* Process Section */}
                <section className="pt-[150px]  px-4 sm:px-6 lg:px-8 bg-purple-50">
